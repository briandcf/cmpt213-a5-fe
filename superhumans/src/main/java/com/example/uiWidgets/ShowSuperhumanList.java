...
/**
 *   Shows the widget to show all the superhumans a superhuman
 */

public class ShowSuperhumanList {

    private static ArrayList<String> attrs;
    private static VBox listBox;
    private static SuperhumanList list;

    public static VBox listSupers(SuperhumanList sh){
        list = sh;
        listBox = new VBox();
        attrs = new ArrayList<>();
        attrs.addAll(Arrays.asList("ID", "Name", "Weight", "Height", "Type", "Strength"));

        listBox.setStyle("-fx-border-width: 2; -fx-border-color: teal;");
        ...
        listBox.getChildren().addAll(header, getlist());
        return listBox;
    }
    ...
    private static CheckBox getCheckbox(String attribute){
        ...
        checkBox.setOnAction((ActionEvent e) -> {
            ...
            listBox.getChildren().set(1, getlist());
    ...
    private static ScrollPane getlist(){
        ...
        for(Superhuman superh: list.getSuperhumanList()){
    ...
    private static HBox makeSuperHumanBox(Superhuman superH){
        ...
        ImageView imageView = Images.getCroppedLargestCircleImage(superH.getPictureURL(), 81);
    ...
    private static void addApropriateAttributes(VBox one, VBox two, VBox three, Superhuman sh){
        ...
        for(int i = 0; i < attrs.size(); i ++){
            ...
            if(attrs.get(i).equals("ID")){
                ...
                box.getChildren().add(getAttributeBox("Type", ("" + sh.getType())));
